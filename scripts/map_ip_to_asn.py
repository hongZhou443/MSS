...
"""
    Source: https://github.com/estcarisimo/map-ip-to-asn/blob/main/README.md
"""
...
def main():
    ...
    df = pd.read_csv('./data/gov_mailserver_a_results.csv')
    ...
    df["asn"] = df["ipv4"].apply(ip_to_asn_mapper.get_ip_to_asn)
